...
if ($figura) {
    if ($figura == "Triangle" && isset($_POST['lado1'], $_POST['lado2'], $_POST['lado3'])) {
        $lado1 = $_POST['lado1'];
        $lado2 = $_POST['lado2'];
        $lado3 = $_POST['lado3'];
    ...
    } elseif ($figura == "Rectangle" && isset($_POST['lado1'], $_POST['lado2'])) {
        $lado1 = $_POST['lado1'];
        $lado2 = $_POST['lado2'];
